...
cost_f(W)=C2_model1_correct_theta(theta,Delta,Lx,Ly,P,M,kxs,kys,W)
...
jld_filenm="C2_model1_theta"*string(theta)*"_M"*string(M)*".jld";
save(jld_filenm, "W",W,"E0",E0);

mat_filenm="C2_model1_theta"*string(theta)*"_M"*string(M)*".mat";
