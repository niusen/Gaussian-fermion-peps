...
cost_f(W)=Hofstadter_triangle_2site(t,Lx,Ly,P,M,kxs,kys,W);
...
jld_filenm="Hofstadter_triangle_2site_M"*string(M)*".jld";
save(jld_filenm, "W",W,"E0",E0);

mat_filenm="Hofstadter_triangle_2site_M"*string(M)*".mat";
