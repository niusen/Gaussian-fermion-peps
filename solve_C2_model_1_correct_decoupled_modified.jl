...
cost_f(W)=C2_model1_correct_decoupled_modified(Phx,Phz,Delta,Lx,Ly,P,M,kxs,kys,W);
...
jld_filenm="C2_model1_correct_decoupled_modified_M"*string(M)*".jld";
save(jld_filenm, "W",W,"E0",E0);

mat_filenm="C2_model1_correct_decoupled_modified_M"*string(M)*".mat";
